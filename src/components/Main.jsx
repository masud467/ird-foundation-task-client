...
import { BiCopy, BiBookmark, BiShareAlt } from "react-icons/bi"; // Example icons for actions
        ...
        {duas.map((dua) => (
          ...
          >
            ...
            <div className="flex items-center justify-end space-x-4 text-gray-500">
              <BiCopy className="cursor-pointer hover:text-green-600" />
              <BiBookmark className="cursor-pointer hover:text-green-600" />
              <FiInfo className="cursor-pointer hover:text-green-600" />
              <BiShareAlt className="cursor-pointer hover:text-green-600" />
            </div>
          </div>
        ))}
      </div>
